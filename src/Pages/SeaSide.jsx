...
export default function SeaSide() {
    const swiperRef = useRef(null);
      ...
      const slides = [
      {
        ...
        video: "https://html.themewant.com/moonlit/assets/images/video/Moonlit.mp4",
      },
      {
...
<Header />
  ...
  <div className="relative w-full h-[120vh] group">
    ...
    >
      ...
      <div className="relative sm:absolute sm:bottom-0 sm:left-1/2 sm:transform sm:-translate-x-1/2 sm:translate-y-1/2 z-40 w-[95%] sm:w-[90%] lg:w-[80%] xl:w-[70%] mt-6 sm:mt-0">
        <div className="bg-black rounded-2xl shadow-lg px-3 py-2 sm:px-6 sm:py-4 w-full">
          <Booking />
        </div>
      </div>
   ...
   <section className="px-4 sm:px-8 md:px-12 lg:px-20 bg-black">
  <div className="flex flex-col md:flex-row-reverse mt-40 items-center md:items-start max-w-[1400px] mx-auto relative">
    ...
    <div className="relative w-full md:w-[900px] p-4">
      ...
      {/* Experience Info Box */}
      <div className="absolute top-20 right-5 sm:right-10 md:right-2 bg-black bg-opacity-90 p-4 sm:p-6 rounded-lg shadow-lg flex items-center space-x-3 w-50 sm:w-60">
        ...
        <div className="px-2 sm:px-5">
          <div className="text-lg sm:text-xl font-semibold text-white">50+</div>
          <div className="text-sm sm:text-base text-white">Experience Staff</div>
        </div>
      </div>
    </div>
    ...
    <div className="w-full md:w-1/2 mt-10  md:mt-0 md:mr-20">
      ...
      {/* Heading */}
      <h2 className="text-4xl text-white sm:text-3xl md:text-5xl font-serif py-6 mb-4 leading-snug">
